...
# $Id: config.inc,v 1.13 2003/01/14 10:22:45 jberanek Exp $
...
#################################
$reserve_admin = "MY ADMIN NAME";
$reserve_admin_email = "admin@mycompany.com";
$reserve_company = "MY COMPANY";

$reserve_base_http = "Location: https://".$_SERVER['HTTP_HOST'] .dirname($_SERVER['PHP_SELF']);
